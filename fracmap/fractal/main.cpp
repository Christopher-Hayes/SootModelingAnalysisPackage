...
main(int argc, char **argv) {
  ...
  if (p.check_r()) {
    ...
    string command = "/Users/chris/Downloads/libigl_repo/libigl/tutorial/build/102_DrawMesh_bin /Users/chris/Downloads/nanogui_repo/nanogui" + xyz_filepath.substr(1);
